...
| [0002](0002-gpl-3-licence-and-asset-provenance.md) | GPL-3.0-or-later, SPDX headers, asset provenance; common RowPlay-family assets we author are MIT, their tooling GPL (amended) |
...
| [0016](0016-authored-overcast-lighting.md) | Script-generated, prefiltered skies permitted; Direction C rowing and blue-hour companion; stationary course cues, unchanged replay mechanics; procedural assets from reviewed scripts, modelled assets from a reviewed `.blend` plus a deterministic export and validation script; outputs and `.blend` sources MIT, tooling GPL (amended) |
